        ...
        sendSelfieBtn.setOnClickListener {
            photoUri?.let {
                val emailIntent = Intent(Intent.ACTION_SEND).apply {
                    type = "image/*"
                    putExtra(Intent.EXTRA_EMAIL, arrayOf("hodovycnko@op.edu.ua"))
                    putExtra(Intent.EXTRA_SUBJECT, "ANDROID Прізвище Ім’я")
                    putExtra(Intent.EXTRA_TEXT, "Проєкт тут: https://github.com/LiseevKirill/AndroidOC_AllLabs/tree/main/AllLabs")
